                        ...
                        <div x-show="accountEdit" @click.away="accountEdit = false"
                            ...
                            @foreach ($accounts as $account)
                                <div x-show="itemToEdit === {{ $account->id }}">
                                    <form method="post"
                                        :action="`{{ route('accounts.update_account', '') }}/${itemToEdit}`">
                                        @csrf
                                        @method('patch')
                                        ...
                                        <div class="p-4 md:p-5 space-y-4">
                                            <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                                {{-- <div>
                                <label for="id" class="block mb-2 text-sm font-medium text-gray-900">UserID</label>
                                <input type="text" name="id" value="{{ $account->id }}" class="bg-gray-100 border border-gray-300 text-gray-900" disabled>
                            </div> --}}
                                                <div>
                                                    <label for="name"
                                                ...
                                                <div>
                                                    ...
                                                    <input type="text" name="phone" value="{{ $account->phone }}"
                                                        class="bg-gray-100 border border-gray-600 text-gray-900"
                                                        required>
                                                </div>
                                ...
                                <select name="shift" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block mb-3 p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white w-11/12 " required>
                                    <option value="Day" {{ $account->shift === 'Day' ? 'selected' : '' }}>Day</option>
                                    <option value="Night" {{ $account->shift === 'Night' ? 'selected' : '' }}>Night</option>
                                </select>
                            </div>

                            <div>
                                <label for="emergency_phone">Emergency Phone Number</label>
                                <input type="text" name="emergency_phone" value="{{ $account->emergency_phone }}" class="bg-gray-100 border border-gray-600 text-gray-900" required>
                            </div> --}}
                                            </div>
                                        </div>
